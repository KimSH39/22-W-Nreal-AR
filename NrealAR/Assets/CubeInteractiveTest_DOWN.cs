...
namespace NRKernal.NRExamples
{
    ...
    public class CubeInteractiveTest_DOWN : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
            ...
            string jsonData = "{\"commands\":[{\"component\":\"main\",\"capability\":\"samsungvd.remoteControl\",\"command\":\"send\",\"arguments\":[\"DOWN\"\r\n]}]}";
