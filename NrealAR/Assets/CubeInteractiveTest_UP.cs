...
namespace NRKernal.NRExamples
{
    ...
    public class CubeInteractiveTest_UP : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
            ...
            string jsonData = "{\"commands\":[{\"component\":\"main\",\"capability\":\"samsungvd.remoteControl\",\"command\":\"send\",\"arguments\":[\"UP\"\r\n]}]}";
