...
namespace NRKernal.NRExamples
{
    ...
    public class CubeInteractiveTest_WC : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
            ...
            string jsonData = "{ \"commands\": [ { \"component\": \"main\", \"capability\": \"custom.launchapp\", \"command\": \"launchApp\", \"arguments\":[\"\",\"Watcha\"] } ] }";
