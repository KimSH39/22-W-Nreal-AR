...
namespace NRKernal.NRExamples
{
    ...
    public class CubeInteractiveTest_RIGHT : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        {
            m_MeshRender.material.color = Color.gray;

            string jsonData = "{\"commands\":[{\"component\":\"main\",\"capability\":\"samsungvd.remoteControl\",\"command\":\"send\",\"arguments\":[\"RIGHT\"\r\n]}]}";
