...
namespace NRKernal.NRExamples
{
    ...
    public class CubeInteractiveTest_ChDOWN : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
            ...
            string jsonData = "{\"commands\":[{\"component\":\"main\",\"capability\":\"tvChannel\",\"command\":\"channelDown\",\"arguments\":[],\"name\":\"channelDown\"}]}";
