...
namespace NRKernal.NRExamples
{
    ...
    public class CubeInteractiveTest_NF : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
            ...
            string jsonData = "{ \"commands\": [ { \"component\": \"main\", \"capability\": \"custom.launchapp\", \"command\": \"launchApp\", \"arguments\":[\"\",\"Netflix\"] } ] }";
        ...
        /// <summary> when pointer hover, set the cube color to red. </summary>
        /// <param name="eventData"> Current event data.</param>
