...
namespace NRKernal.NRExamples
{
    ...
    public class CubeInteractiveTest_YT : MonoBehaviour, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        {
            m_MeshRender.material.color = Color.cyan;

            string jsonData = "{ \"commands\": [ { \"component\": \"main\", \"capability\": \"custom.launchapp\", \"command\": \"launchApp\", \"arguments\":[\"\",\"YouTube\"] } ] }";
